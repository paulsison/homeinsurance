...
public class Scenario_10 {
	 ...
	 * to renew a policy belonging to a specific user. */
	...
	public void RetrieveQuoteTest() throws IOException {
		...
		//We select the previously cancelled policy in Scenario 9 for renewal
		assertThat(topPolicyIdString, equalTo("inactive"));
		takeScreenShot(driver);
		
		driver.findElement(By.cssSelector("body > table > tbody > tr:nth-child(2) > td:nth-child(7) > a")).click();
		
		// refreshing the search
		WebElement userToSearchElem2 = driver.findElement(By.cssSelector("body > form > div:nth-child(1) > input[type=\"text\"]"));
		userToSearchElem2.sendKeys(userToSearch);
		driver.findElement(By.cssSelector("body > form > div:nth-child(2) > input[type=\"submit\"]")).click();

		WebElement topPolicyIdElem2 = driver.findElement(By.cssSelector("body > table > tbody > tr:nth-child(2) > td:nth-child(6)"));
		String topPolicyIdString2 = topPolicyIdElem2.getText();

		assertThat(topPolicyIdString2, equalTo("active"));
		takeScreenShot(driver);
