...
public class Scenario_09 {
	 ...
	 * to cancel a policy belonging to a specific user. */
	...
	public void RetrieveQuoteTest() throws IOException {
		...
		//Policy must be active for us to cancel it
		assertThat(topPolicyIdString, equalTo("active"));
		
		driver.findElement(By.cssSelector("body > table > tbody > tr:nth-child(2) > td:nth-child(8) > a")).click();
		...
		assertThat(topPolicyIdString2, equalTo("inactive"));
		takeScreenShot(driver);
